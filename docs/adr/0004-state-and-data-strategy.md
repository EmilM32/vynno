...
- Session/prefs state is request-scoped via context on the server and a client singleton after hydrate — see [ADR-0011](./0011-ssr-session-state.md) and [ssr-enablement.md](../ssr-enablement.md).
