...
Lightweight ADRs for the DevTime **frontend** repository.
...
Each ADR captures: context, decision, consequences, alternatives. New decisions get the next number (`0006-…`).
