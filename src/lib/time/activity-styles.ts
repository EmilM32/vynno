...
export const ACTIVITY_CHIP_CLASS: Record<ActivityType, string> = {
	...
	maintenance: 'bg-primary-container/10 text-primary-container border-primary-container/20',
	...
	research: 'bg-primary-fixed/10 text-primary-fixed-dim border-primary/20',
